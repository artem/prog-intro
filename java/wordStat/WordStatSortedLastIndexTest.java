 ...
 */
public class WordStatSortedLastIndexTest {
    private final WordStatIndexChecker checker;

    public WordStatSortedLastIndexTest(final String className) {
        checker = new WordStatIndexChecker(className);
    }

    public static void main(final String... args) {
        new WordStatSortedLastIndexTest("WordStatSortedLastIndex").run();
    }
